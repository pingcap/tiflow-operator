...
//+kubebuilder:rbac:groups=pingcap.com.pingcap.com,resources=tiflowclusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=pingcap.com.pingcap.com,resources=tiflowclusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=pingcap.com.pingcap.com,resources=tiflowclusters/finalizers,verbs=update
